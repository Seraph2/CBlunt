...
<<<<<<< HEAD
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitIdentifier([NotNull] CBluntParser.IdentifierContext context) { return VisitChildren(context); }
	/// <summary>
...
>>>>>>> test-antlr
	...
	/// <return>The visitor result.</return>
<<<<<<< HEAD
	public virtual Result VisitTypes([NotNull] CBluntParser.TypesContext context) { return VisitChildren(context); }
=======
	public virtual Result VisitIdentifier([NotNull] CBluntParser.IdentifierContext context) { return VisitChildren(context); }
>>>>>>> test-antlr
}
