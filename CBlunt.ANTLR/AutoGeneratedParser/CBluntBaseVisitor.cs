...
public partial class CBluntBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICBluntVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="CBluntParser.operand"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitOperand([NotNull] CBluntParser.OperandContext context) { return VisitChildren(context); }
}
} // namespace CBlunt.ANTLR.AutoGeneratedParser
